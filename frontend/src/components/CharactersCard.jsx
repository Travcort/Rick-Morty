...
const DetailsCard = ({ id, status, name, species, gender, image, origin, location }) => {
    const background = useColorModeValue("blue.900", "gray.300");
    const textColour = useColorModeValue("white", "black");
    return (
        <Card direction={'row'} variant={'elevated'} maxW={'sm'} margin={'auto'} mt={5} borderRadius={10} bg={background}>
